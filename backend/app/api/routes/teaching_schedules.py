...
def get_learning_schedules_by_id(
    ...
    return TeachingScheduleServices.get_by_id(session=session, teaching_schedule_id=id, request=request)
...
def update_teaching_schedules(
    ...
    return TeachingScheduleServices.update(session=session, teaching_schedule_id=id, teaching_schedules_data=data)
