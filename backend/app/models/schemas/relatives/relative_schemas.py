...
class RelativeBase(SQLModel):
    ...
    date_of_birth: datetime | None = Field(default=None, sa_column=Column(DateTime, nullable=True))
    ...
    occupation: str | None = Field(default=None, sa_column=Column(String(100), nullable=True))
    ...
    relationship: str | None = Field(default=None, sa_column=Column(String(50), nullable=True))
...
class RelativeUpdate(SQLModel):
    ...
    date_of_birth: Optional[datetime] | None = Field(default=None, sa_column=Column(DateTime, nullable=True))
    ...
    occupation: Optional[str] | None = Field(default=None, sa_column=Column(String(100), nullable=True))
    phone: Optional[str] | None = Field(default=None, sa_column=Column(String(20), nullable=True))
    address: Optional[str] | None = Field(default=None, sa_column=Column(Text, nullable=True))
    relationship: Optional[str] | None = Field(default=None, sa_column=Column(String(50), nullable=True))
