...
class SpecializationBase(SQLModel):
    specialization_code: str = Field(sa_column=Column(String(12), nullable=False, unique=True))
...
class SpecializationUpdate(SQLModel):
    specialization_code: str | None = Field(default=None, sa_column=Column(String(12), nullable=True))
