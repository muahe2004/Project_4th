...
class UserInformationBase(SQLModel):
    place_of_origin: str | None = Field(
        default=None, sa_column=Column(Text, nullable=True)
    )
    exempted_group: str | None = Field(
        default=None, sa_column=Column(Text, nullable=True)
    )
    priority_group: str | None = Field(
        default=None, sa_column=Column(Text, nullable=True)
    )
    citizen_id: str | None = Field(
        default=None, sa_column=Column(String(12), nullable=True)
    )
    issue_date: datetime | None = Field(
...
class UserInformationUpdate(SQLModel):
    place_of_origin: Optional[str] | None = Field(
        default=None, sa_column=Column(Text, nullable=True)
    )
    exempted_group: Optional[str] | None = Field(
        default=None, sa_column=Column(Text, nullable=True)
    )
    priority_group: Optional[str] | None = Field(
        default=None, sa_column=Column(Text, nullable=True)
    )
    citizen_id: Optional[str] | None = Field(
        default=None, sa_column=Column(String(12), nullable=False, unique=True)
    )
    issue_date: Optional[datetime] = Field(
        default=None, sa_column=Column(DateTime, nullable=True)
    )
    issue_place: Optional[str] | None = Field(
        default=None, sa_column=Column(String(100), nullable=True)
    )
    ...
    insurance_number: Optional[str] | None = Field(
        default=None, sa_column=Column(String(20), nullable=True)
    )
    ...
    bank_name: Optional[str] | None = Field(
        default=None, sa_column=Column(String(100), nullable=True)
    )
    bank_account_number: Optional[str] | None = Field(
        default=None, sa_column=Column(String(30), nullable=True)
    )
    updated_at: datetime = Field(
        default_factory=datetime.now, sa_column=Column(DateTime, nullable=False)
