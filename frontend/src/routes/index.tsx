  ...
  return createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: studentTuitionFeesUrl,
          element: <StudentTuitionFees />,
        },
        {
        ...
        {
          path: teacherManagementListStudentScoreUrl,
          element: <ListStudentScoreSubject/>
        },
        {
          path: advisorClassScoreUrl,
          element: <AdvisorClassScore/>
        },
        {
