...
const rows = [
  createData("1", "111111", "Đại số tuyến tính", "2", "1.0", "8.5", "7.0", "7.8", "-", "-", "-", "7.8", "3.0", "Khá", ""),
  createData("2", "921113", "Giáo dục thể chất 1", "1", "1.0", "9.0", "8.5", "8.8", "-", "-", "-", "8.8", "3.5", "Giỏi", ""),
  createData("3", "211132", "Lập trình Python cơ bản (2+1*)", "3", "1.0", "7.5", "7.0", "7.2", "-", "-", "-", "7.2", "3.0", "Khá", ""),
  createData("4", "921204", "Giáo dục quốc phòng và an ninh", "5", "1.0", "8.0", "8.5", "8.3", "-", "-", "-", "8.3", "3.5", "Giỏi", ""),
  createData("5", "211214", "Công dân số (2+1*)", "3", "1.0", "9.0", "8.0", "8.5", "-", "-", "-", "8.5", "3.5", "Giỏi", ""),
  createData("6", "911602", "Pháp luật đại cương", "2", "1.0", "8.5", "9.0", "8.7", "-", "-", "-", "8.7", "3.5", "Giỏi", ""),
  createData("7", "131001", "Hóa học đại cương (1.5+0.5*)", "2", "1.0", "7.0", "7.5", "7.3", "-", "-", "-", "7.3", "3.0", "Khá", ""),
  createData("8", "711170", "Kỹ năng mềm", "2", "1.0", "9.0", "8.5", "8.8", "-", "-", "-", "8.8", "3.5", "Giỏi", ""),
  createData("9", "911102", "Triết học Mác - Lênin", "3", "1.0", "7.0", "7.5", "7.3", "-", "-", "-", "7.3", "3.0", "Khá", ""),
  createData("10", "111126", "Giải tích", "3", "1.0", "8.5", "8.0", "8.3", "-", "-", "-", "8.3", "3.5", "Giỏi", ""),
  createData("11", "921114", "Giáo dục thể chất 2", "1", "1.0", "6.5", "7.0", "6.8", "-", "-", "-", "6.8", "2.5", "TB", ""),
  createData("12", "221104", "Kiến trúc máy tính", "3", "1.0", "9.0", "9.5", "9.3", "-", "-", "-", "9.3", "4.0", "Xuất sắc", ""),
  createData("13", "211002", "Cơ sở kỹ thuật lập trình (2+1*)", "3", "1.0", "9.0", "8.5", "8.8", "-", "-", "-", "8.8", "3.5", "Giỏi", ""),
  createData("14", "231027", "Cơ sở dữ liệu", "3", "1.0", "8.0", "7.5", "7.8", "-", "-", "-", "7.8", "3.0", "Khá", ""),
  createData("15", "921115", "Giáo dục thể chất 3", "1", "1.0", "7.5", "8.0", "7.8", "-", "-", "-", "7.8", "3.0", "Khá", ""),
  createData("16", "211156", "Hệ quản trị cơ sở dữ liệu (2+1*)", "3", "1.0", "6.5", "7.0", "6.8", "-", "-", "-", "6.8", "2.5", "TB", ""),
  createData("17", "211131", "Cấu trúc dữ liệu và giải thuật (2+1*)", "3", "1.0", "7.5", "7.0", "7.2", "-", "-", "-", "7.2", "3.0", "Khá", ""),
  createData("18", "221190", "Hệ điều hành (2+1*)", "3", "1.0", "9.0", "8.5", "8.8", "-", "-", "-", "8.8", "3.5", "Giỏi", ""),
  createData("19", "111209", "Giải tích số", "2", "1.0", "8.0", "8.5", "8.3", "-", "-", "-", "8.3", "3.5", "Giỏi", ""),
  createData("20", "211460", "Lập trình hướng đối tượng (2+1*)", "3", "1.0", "7.0", "7.5", "7.3", "-", "-", "-", "7.3", "3.0", "Khá", ""),
];
