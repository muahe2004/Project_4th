...
import { classesUrl, dashBoardUrl, departmentUrl, examinationScheduleUrl, majorUrl, roomUrl, specializationsUrl, studentUrl, subjectUrl, teacherUrl, teachingScheduleUrl, trainingProgramUrl } from "../../routes/urls";
